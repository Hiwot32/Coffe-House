  ...
  return (
        ...
        <div className='flex gap-30 mx-auto text-white items-center'>
            <div className='w-160'>
                ...
                <div className='flex gap-7 pb-6'>
                     <Image src="/images/aboutImg/download (1).svg" alt="cup" width={35} height={35} />
                    <p className='text-lg'><span className='text-xl font-bold'>Food Delivery</span><br />With our fast and reliable food delivery service, your favorite coffee, snacks, and treats are just a click away.</p>
                </div>
                <div className='flex gap-7'>
                    <Image src="/images/aboutImg/download.svg" alt="cup" width={35} height={35} />
    ...
    <div className="absolute top-1/2 left-1/2 w-0 h-full bg-white opacity-20 rotate-12 transform     -translate-x-1/2 -translate-y-1/2
                ...
                <div className={`${about.opening} text-black`}>
                    ...
                    <p className='flex gap-22 py-3'>Saturday <span >10:30-05:00</span></p>
                    <p className='flex gap-24'>Sunday <span >24hrs Open</span></p>
                </div>
